    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="divide-y divide-border/60">
        ...
        <section className="py-6">
          <h2 className="text-sm font-semibold text-foreground mb-1">Notificações por e-mail</h2>
        ...
        {/* Export */}
        <section className="py-6">
          <h2 className="text-sm font-semibold text-foreground mb-1">Exportar meus dados</h2>
          <p className="text-sm text-muted-foreground mb-4">
        ...
        {/* Delete */}
        <section className="py-6">
          <h2 className="text-sm font-semibold text-destructive mb-1">Excluir conta</h2>
          <p className="text-sm text-muted-foreground mb-4">
